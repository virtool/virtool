...
| `VT_STORAGE_AZURE_DOWNLOAD_URL` | URL string | Unset | Rehost a redirected download's SAS URL onto a public host, such as `https://files.virtool.ca`. Applies only in `redirect` download mode. |
