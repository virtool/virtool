...
3. Wait for the installation to complete.
   ...
   When the installation is complete, the HMM data loads and you see a list of
...
It's possible to delete all HMM data from the disk and database. This is used primary
