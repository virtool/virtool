...
1. Click the <DummyButton icon="key">Create</DummyButton> button to open the creation
   ...
   Permissions that aren't granted to your account are turned off and greyed out. If permissions are removed from your account after the key is created, they're also removed from the key.
