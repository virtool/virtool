...
1. Click the <DummyButton icon="key">Create</DummyButton> button to open the creation
   ...
   Permissions that are not granted to your account will be turned off and greyed out. If permissions are removed from your account after the key is created, they will also be removed from the key.
