...
The values for weight, depth, and coverage are all very high, so the pathogens can be confidently
...
viruses are usually not found in tree fruits so this is likely a case of
contamination.
...
depth is 14. This is very small compared to the max depth in a high quality positive
...
shown. The taxonomic families associated with the HMM data are also display preceding the
