...
**Analysis deletion is permanent**. A deleted analysis cannot be recovered.
...
5. Clicking an OTU shows coverage charts for the isolates
   ...
   - Isolates with high weight, and deep localized coverage are typical of low-complexity
     or host-similar regions in the isolate genome and do not show true infections.
...
coverage, indicating that they are not present in the sample. These results indicate
...
This indicates that these contigs do not represent novel viral genomes.
However, they do not exist in the Virtool reference database because they were not
...
identities 1.00. Based on their scores, they are all similar matches. Knowing that
