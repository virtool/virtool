...
However, they do not exist in our reference database in Virtool because they were not
...
significant BLAST hits to known viruses (for example, Nectarine marafivirus M), however the
