...
By default, sample names must be unique to the sample manager. This prevents confusion between identically named samples. It is possible to disable this feature. To do so, click **Settings** on the left sidebar under the samples overview page.
