...
3. Fill the form with your **source type** and **source name** values
   ...
   Notice that the **Isolate Name** field changes with the other two fields. Both fields are optional and the isolate name will be **Unnamed** if they are both empty. Many isolates in a single OTU can have the same name.
...
1. Locate the segment you want to edit
   ...
   ![DNA-A will be edited](./segments_added.png?url)
