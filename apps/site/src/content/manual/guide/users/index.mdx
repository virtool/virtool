...
actions users are allowed to perform and what resources they're allowed to access.

## Concepts

### Ownership

When users create new data items (such as samples, references, and jobs), they're automatically
...
Permissions control which app-wide actions users can perform. Permissions are
...
Administrators automatically pass all permission and right checks.

## Create a user

1. Navigate to the **Users** tab under **Administration**.
...
3. Click <DummyButton icon="save">Save</DummyButton>
   ...
   existing sessions and requires them to reset their password when they try to access
   Virtool.

## Change a user's group membership

You can change a user's group membership.
