...
export class UserItem extends React.Component {
  ...
  render() {
    ...
    const currentRole = this.props.detail.administrator
      ? "Administrator"
      : "Limited";

    const canModifyUser =
      this.props.activeUser !== this.props.detail.id &&
      this.props.activeUserIsAdmin;
      ...
      <div>
        <Flex justifyContent="space-between">
          <Flex alignItems="center">
            ...
            <FlexItem pad={10}>
              {this.props.detail.administrator ? (
        ...
        <div style={{ marginTop: "20px" }}>
          ...
          <UserGroups
            ...
            memberGroups={this.props.detail.groups}
          />
