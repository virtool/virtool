...
describe("<General />", () => {
    ...
    it("renders correctly", () => {
        ...
        expect(wrapper.find(Badge).html())
            .toEqual("<span class=\"badge\">5 changes</span>");
        ...
        expect(wrapper.find(Badge).html())
            .toEqual("<span class=\"badge\">1 change</span>");
    });
    ...
    it("renders <IndexOTUEntry /> subcomponent", () => {
        ...
        expect(wrapper).toMatchSnapshot();
        expect(wrapper.childAt(1).html())
            .toEqual("<span class=\"badge\">3 changes</span>");
