                  ...
                  <Flex>
                    <FlexItem>
                      <Checkbox
                        ...
                        onClick={() =>
                          props.onUpdateSetting("show_ids", !settings.show_ids)
                        }
                      />
                    </FlexItem>
                    <FlexItem pad={10}>
                      ...
                      <small>
                        Show the unique database IDs for Virtool records where
                        possible. This is not required for normal use, but is
