...
export const getFilterIds = createSelector([getResults, getFilterSequences], (results, filterSequences) => {
...
export const getSortIds = createSelector([getResults, getSortKey], (results, sortKey) => {
    if (sortKey === "e") {
...
export const getActiveHit = createSelector([getMatches, getActiveId], (matches, activeId) => {
    if (activeId !== null) {
