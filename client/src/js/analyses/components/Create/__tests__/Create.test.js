...
describe("<CreateAnalysis />", () => {
    ...
    it("should submit with expected values", () => {
        ...
        userEvent.click(screen.getByText(props.subtractionList[0].name));
    ...
    it("should automatically select default subtractions", () => {
        ...
        props.defaultSubtractions = props.subtractionList.map(subtraction => subtraction.id);
