...
export class Resources extends React.Component {
    ...
    render() {
        ...
        const errorMessageProc = getErrorMessage(this.state.errorProc, this.props.minProc, this.props.maxProc);

        const errorMessageMem = getErrorMessage(this.state.errorMem, this.props.minMem, this.props.maxMem);
