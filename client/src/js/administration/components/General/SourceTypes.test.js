...
describe("<SourceTypes />", () => {
  ...
  describe("SourceTypes component", () => {
    ...
    it("handleSubmit()", () => {
      ...
      wrapper.instance().handleSubmit(mockEvent);
      expect(
        initialProps.onUpdate.calledWith(["test", "foobar"], false, "123abc")
      ).toBe(true);
  ...
  describe("dispatch actions", () => {
    ...
    it("updates global reference 'default_source_types' setting on update", () => {
      ...
      expect(
        spyUpdateSetting.calledWith("default_source_types", ["test"])
      ).toBe(true);
    });
    ...
    it("edits specific reference 'source_types' setting on update", () => {
      ...
      expect(spyEditRef.calledWith("123abc", { source_types: ["test"] })).toBe(
        true
      );
    });
    ...
    it("edits specific reference 'restrict_source_types' setting on toggle", () => {
      ...
      expect(
        spyEditRef.calledWith("123abc", { restrict_source_types: true })
      ).toBe(true);
    });
  });
});
