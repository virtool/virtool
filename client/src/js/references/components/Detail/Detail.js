...
class ReferenceDetail extends React.Component {
  ...
  handleSelect = key => {
    followDownload(
      `/download/refs/${this.props.match.params.refId}?scope=${key}`
    );
  };
  ...
  render = () => {
    ...
    if (
      ...
      this.props.detail.id !== this.props.match.params.refId
    ) {
    ...
    if (this.props.pathname === `/refs/${id}/manage`) {
      ...
      exportButton = (
        <Dropdown
          ...
          className="dropdown-export-reference"
        >
    ...
    const isUpdatingRemote = isRemoteUpdate(
      this.props.detail,
      ...
      <div className="detail-container">
        ...
        <Switch>
          ...
          <Route
            ...
            render={({ match }) => (
              <ReferenceManage match={match} isUpdating={isUpdatingRemote} />
            )}
          />
