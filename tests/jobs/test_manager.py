...
@pytest.fixture
def test_job_manager(loop, mocker, tmpdir, test_motor):
    settings = {
        "proc": 6,
        "mem": 24,
        "dummy_proc": 2,
    ...
    manager = virtool.jobs.manager.Manager(loop, test_motor, settings, mocker.stub("capture_exception"))
...
class TestReserveResources:
    ...
    async def test_multiple(self, test_job_manager):
        mock_job_1 = virtool.jobs.job.Job(
            test_job_manager.loop,
            test_job_manager.executor,
            test_job_manager.db,
            test_job_manager.settings,
        ...
        mock_job_2 = virtool.jobs.job.Job(
            test_job_manager.loop,
            test_job_manager.executor,
            test_job_manager.db,
            test_job_manager.settings,
