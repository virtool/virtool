...
from virtool.references.oas import ReferenceCreateRequest
...
def test_schema(update_dict, mock_create_reference_schema):
    ReferenceCreateRequest(**mock_create_reference_schema)
...
@pytest.mark.parametrize(
    "value",
    ["release_id", "import_from", "clone_from", "remote_from"],
)
