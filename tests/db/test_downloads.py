...
async def test_generate_sequence_fasta(test_dbi, test_otu, test_sequence):
    ...
    assert await virtool.db.downloads.generate_sequence_fasta(test_dbi, test_sequence["_id"]) == expected


async def test_generate_isolate_fasta(test_dbi, test_otu, test_sequence):
    await test_dbi.otus.insert_one(test_otu)
...
async def test_generate_virus_fasta(test_dbi, test_otu, test_sequence):
    ...
    assert await virtool.db.downloads.generate_otu_fasta(test_dbi, test_otu["_id"]) == expected
