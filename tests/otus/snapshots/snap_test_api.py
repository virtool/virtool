...
snapshots['TestCreate.test[True-pyloop-None-True] response'] = {
    'abbreviation': '',
    'id': '9pfsom1b',
    'isolates': [
    ],
...
snapshots['TestCreate.test[True-pyloop-None-True] otu'] = {
    '_id': '9pfsom1b',
    'abbreviation': '',
    'isolates': [
    ],
...
snapshots['TestCreate.test[True-pyloop-None-True] history'] = {
    '_id': '9pfsom1b.0',
    'created_at': GenericRepr('datetime.datetime(2015, 10, 6, 20, 0)'),
    'description': 'Created Tobacco mosaic virus',
    'diff': {
...
snapshots['TestCreate.test[True-pyloop-True] response'] = {
    'abbreviation': '',
    'id': '9pfsom1b',
    'isolates': [
    ],
...
snapshots['TestCreate.test[True-pyloop-True] otu'] = {
    '_id': '9pfsom1b',
    'abbreviation': '',
    'isolates': [
    ],
...
snapshots['TestCreate.test[True-pyloop-True] history'] = {
    '_id': '9pfsom1b.0',
    'created_at': GenericRepr('datetime.datetime(2015, 10, 6, 20, 0)'),
    'description': 'Created Tobacco mosaic virus',
    'diff': {
...
snapshots['TestCreate.test[True-pyloop-TMV-True] response'] = {
    'abbreviation': 'TMV',
    'id': '9pfsom1b',
    'isolates': [
    ],
...
snapshots['TestCreate.test[True-pyloop-TMV-True] otu'] = {
    '_id': '9pfsom1b',
    'abbreviation': 'TMV',
    'isolates': [
    ],
...
snapshots['TestCreate.test[True-pyloop-TMV-True] history'] = {
    '_id': '9pfsom1b.0',
    'created_at': GenericRepr('datetime.datetime(2015, 10, 6, 20, 0)'),
    'description': 'Created Tobacco mosaic virus (TMV)',
    'diff': {
...
snapshots['TestSetAsDefault.test[True-pyloop] response'] = {
    'default': True,
    'id': 'test',
    'sequences': [
    ],
...
snapshots['TestSetAsDefault.test[True-pyloop] joined'] = {
    '_id': '6116cba1',
    'abbreviation': 'PVF',
    'imported': True,
    'isolates': [
...
snapshots['TestSetAsDefault.test[True-pyloop] history'] = {
    '_id': '6116cba1.1',
    'created_at': GenericRepr('datetime.datetime(2015, 10, 6, 20, 0)'),
...
snapshots['TestSetAsDefault.test_no_change[True-pyloop] response'] = {
    'default': True,
    'id': 'cab8b360',
    'sequences': [
    ],
...
snapshots['TestSetAsDefault.test_no_change[True-pyloop] joined'] = {
    '_id': '6116cba1',
    'abbreviation': 'PVF',
    'imported': True,
    'isolates': [
