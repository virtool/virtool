...
snapshots['test_create[pyloop] 1'] = {
    '_id': '9pfsom1b',
    'abbreviation': '',
    'isolates': [
    ],
...
snapshots['test_create[pyloop] 2'] = {
    '_id': '9pfsom1b.0',
    'created_at': GenericRepr('datetime.datetime(2015, 10, 6, 20, 0)'),
    'description': 'Created Bar',
    'diff': {
...
snapshots['test_create[pyloop-TMV] 1'] = {
    '_id': '9pfsom1b',
    'abbreviation': 'TMV',
    'isolates': [
    ],
...
snapshots['test_create[pyloop-TMV] 2'] = {
    '_id': '9pfsom1b.0',
    'created_at': GenericRepr('datetime.datetime(2015, 10, 6, 20, 0)'),
    'description': 'Created Bar (TMV)',
    'diff': {
...
snapshots['test_edit[pyloop-None] otu'] = {
    '_id': '6116cba1',
    'abbreviation': 'PVF',
    'imported': True,
    'isolates': [
...
snapshots['test_edit[pyloop-None] history'] = {
    '_id': '6116cba1.1',
    'created_at': GenericRepr('datetime.datetime(2015, 10, 6, 20, 0)'),
    'description': 'Changed name to Foo Virus',
    'diff': [
...
snapshots['test_edit[pyloop-TMV] otu'] = {
    '_id': '6116cba1',
    'abbreviation': 'TMV',
    'imported': True,
    'isolates': [
...
snapshots['test_edit[pyloop-TMV] history'] = {
    '_id': '6116cba1.1',
    'created_at': GenericRepr('datetime.datetime(2015, 10, 6, 20, 0)'),
    'description': 'Changed name to Foo Virus and changed abbreviation to TMV',
    'diff': [
