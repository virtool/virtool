...
async def test_add(
    ...
    result = await add(
        app,
        "6116cba1",
        {"source_type": "isolate", "source_name": "B", "default": default},
        "bob",
...
async def test_edit(dbi, snapshot, test_otu, static_time, tmp_path):
    ...
    await edit(
        ...
        "6116cba1",
        "cab8b360",
        {"source_type": "strain", "source_name": "0"},
        "bob",
    )
...
async def test_remove(
    ...
    await remove(app, "6116cba1", isolate_id, "bob")
...
async def test_set_default(dbi, snapshot, test_otu, static_time, tmp_path):
    ...
    return_value = await set_default(app, "6116cba1", "bar", "bob")
