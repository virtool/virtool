...
from virtool.messages.oas import MessageResponse, CreateMessageRequest, CreateMessageResponse, UpdateMessageResponse, \
...
class MessagesView(PydanticView):
    ...
    async def put(self, data: CreateMessageRequest) -> r200[CreateMessageResponse]:
        ...
        instance_message = await get_data_from_req(self.request).messages.create(data, user_id)
    ...
    async def patch(self, data: UpdateMessageRequest) -> Union[r200[UpdateMessageResponse], r404, r409]:
        ...
        """
        try:
            instance_message = await get_data_from_req(self.request).messages.update(data)
