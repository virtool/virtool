...
from virtool.custom_oas.injectors import (
    AbstractInjector,
    BodyGetter,
    HeadersGetter,
    MatchInfoGetter,
...
class PydanticView(AbstractView):
    ...
    def __init_subclass__(cls, **kwargs) -> None:
        ...
        Handlers are decorated if and only if they directly bound on the PydanticView
        class or PydanticView subclass. This prevents that methods are decorated
        multiple times and that method defined in aiohttp.View parent
        class is decorated.
        """
