...
from virtool.http.policy import policy, PermissionsTestRoute
...
class UploadsView(PydanticView):
    ...
    @policy(PermissionsTestRoute(Permission.upload_file))
    async def post(
        self,
        name: str,
...
class UploadView(PydanticView):
    ...
    @policy(PermissionsTestRoute(Permission.remove_file))
