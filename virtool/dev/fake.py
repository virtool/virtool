...
from virtool.fake.test_cases import (analysis_integration,
                                     hmms_integration,
                                     index_integration,
                                     sample_integration,
                                     subtractions_integration)
