...
class AddRelationshipResult:
    """
    The result of adding one or more authorization relationships using the :class:`.AuthorizationClient`.
...
class RemoveRelationshipResult:
    """
    The result of removing one or more authorization relationships using the :class:`.AuthorizationClient`.
