...
from virtool_core.models.__init__ import normalize_hex_color
...
class CreateLabelSchema(BaseModel):
    ...
    _ensure_color_is_normalized: classmethod = validator("color", allow_reuse=True)(normalize_hex_color)
