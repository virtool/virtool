...
//!
//! `tests/golden/vectors.json` holds the committed expected outputs. Behaviour
//! is pinned bug-for-bug, so every value has to match, floats included.
//! **Never edit the corpus to make a failing comparison pass.**
//!
