...
ALTER TABLE "otu_isolate_versions" ADD CONSTRAINT "otu_isolate_versions_isolate_fkey" FOREIGN KEY ("otu_id","isolate_id") REFERENCES "public"."otu_isolates"("otu_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "otu_local_identity_revisions" ADD CONSTRAINT "otu_local_identity_revisions_identity_fkey" FOREIGN KEY ("reference_id","otu_id","identity_id") REFERENCES "public"."otu_local_identities"("reference_id","otu_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "otu_local_sequence_records" ADD CONSTRAINT "otu_local_sequence_records_sequence_fkey" FOREIGN KEY ("otu_id","sequence_id") REFERENCES "public"."otu_sequences"("otu_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "otu_plan_segment_versions" ADD CONSTRAINT "otu_plan_segment_versions_segment_fkey" FOREIGN KEY ("otu_id","segment_id") REFERENCES "public"."otu_plan_segments"("otu_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "otu_plan_segments" ADD CONSTRAINT "otu_plan_segments_plan_fkey" FOREIGN KEY ("otu_id","plan_id") REFERENCES "public"."otu_plans"("otu_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "otu_sequence_versions" ADD CONSTRAINT "otu_sequence_versions_sequence_fkey" FOREIGN KEY ("otu_id","sequence_id") REFERENCES "public"."otu_sequences"("otu_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "otu_sequence_versions" ADD CONSTRAINT "otu_sequence_versions_isolate_fkey" FOREIGN KEY ("otu_id","isolate_id") REFERENCES "public"."otu_isolates"("otu_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "otu_sequence_versions" ADD CONSTRAINT "otu_sequence_versions_segment_fkey" FOREIGN KEY ("otu_id","segment_id") REFERENCES "public"."otu_plan_segments"("otu_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "otu_sequence_versions" ADD CONSTRAINT "otu_sequence_versions_local_record_fkey" FOREIGN KEY ("otu_id","sequence_id","local_record_id") REFERENCES "public"."otu_local_sequence_records"("otu_id","sequence_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "otu_taxonomy_versions" ADD CONSTRAINT "otu_taxonomy_versions_local_identity_revision_fkey" FOREIGN KEY ("reference_id","otu_id","local_identity_revision_id") REFERENCES "public"."otu_local_identity_revisions"("reference_id","otu_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
